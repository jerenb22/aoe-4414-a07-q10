...
# This script simulates the voltage over time for a capacitor-based energy storage system.
#
...
# dur_s: simulation d
# Output:
# A CSV file (log.csv) containing the time (t_s) and capacitor voltage (volts) for each time step.
#
